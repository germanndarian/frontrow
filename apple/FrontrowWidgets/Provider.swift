...
enum SampleGames {
    static let live = Game(
        ...
        lastPlay: nil, period: "2nd", odds: nil, week: nil, field: nil, bases: nil
    )
    ...
    static let next = Game(
        ...
        lastPlay: nil, period: nil, odds: nil, week: nil, field: nil, bases: nil
    )
    ...
    static let later = Game(
        ...
        lastPlay: nil, period: nil, odds: nil, week: 2, field: nil, bases: nil
    )
