...
export const GAMES: Game[] = [
  ...
  /* The rest of the demo's week, and either side of it, so the board has
     something to page through: the games the Yankees' and Oilers' cards list as
     recent form and next up. */
  {
    id: "mlb-5",
    league: "mlb",
    state: "post",
    statusDetail: "Final",
    shortDetail: "Final",
    date: "2026-06-03T23:10:00Z",
    venue: "Tropicana Field",
    away: side({
      teamId: "10",
      abbreviation: "NYY",
      linescores: [0, 2, 0, 0, 3, 0, 1, 0, 0],
      displayName: "New York Yankees",
      shortName: "Yankees",
      logo: logo("mlb", "nyy"),
      color: "#0c2340",
  ...
  },
  {
    ...
    statusDetail: "Final",
    shortDetail: "Final",
    date: "2026-06-02T23:10:00Z",
    venue: "Tropicana Field",
    away: side({
      teamId: "10",
      abbreviation: "NYY",
      linescores: [0, 0, 0, 1, 0, 0, 0, 0, 0],
      displayName: "New York Yankees",
      shortName: "Yankees",
      logo: logo("mlb", "nyy"),
      color: "#0c2340",
  ...
  },
  {
    ...
    statusDetail: "Final",
    shortDetail: "Final",
    date: "2026-06-01T23:05:00Z",
    venue: "Yankee Stadium",
    away: side({
      teamId: "18",
      abbreviation: "HOU",
      linescores: [0, 0, 0, 0, 1, 0, 0, 0, 0],
  ...
  },
  {
    ...
    statusDetail: "Final",
    shortDetail: "Final",
    date: "2026-05-31T17:35:00Z",
    venue: "Yankee Stadium",
    away: side({
      teamId: "18",
      abbreviation: "HOU",
      linescores: [1, 0, 0, 2, 0, 0, 1, 0, 0],
      displayName: "Houston Astros",
      shortName: "Astros",
      logo: logo("mlb", "hou"),
      color: "#002d62",
  ...
  },
  {
    ...
    statusDetail: "Final",
    shortDetail: "Final",
    date: "2026-05-30T23:05:00Z",
    venue: "Yankee Stadium",
    away: side({
      teamId: "3",
      abbreviation: "LAA",
      linescores: [0, 1, 0, 0, 2, 0, 0, 0, 0],
  ...
  },
  {
    ...
    league: "mlb",
    state: "pre",
    statusDetail: "Sat, June 6th at 1:05 PM EDT",
    shortDetail: "6/6 - 1:05 PM EDT",
    date: "2026-06-06T17:05:00Z",
    venue: "Yankee Stadium",
    broadcast: "FOX",
    odds: { details: "NYY -145", overUnder: 8.5, provider: "ESPN BET" },
    away: side({
      teamId: "2",
      abbreviation: "BOS",
      displayName: "Boston Red Sox",
  ...
  },
  {
    ...
    league: "nhl",
    state: "pre",
    statusDetail: "Mon, June 8th at 8:00 PM EDT",
    shortDetail: "6/8 - 8:00 PM EDT",
